...
def rename(*args):
    ...
    headVal =  cmds.floatSliderGrp(headSlider, q=True, value=True)
    bodyVal = cmds.floatSliderGrp(bodySlider, q=True, value=True)
    leftArmVal = cmds.floatSliderGrp(leftArmSlider, q=True, value=True)
    rightArmVal = cmds.floatSliderGrp(rightArmSlider, q=True, value=True)
    leftLegVal = cmds.floatSliderGrp(leftLegSlider, q=True, value=True)
    rightLegVal = cmds.floatSliderGrp(rightLegSlider, q=True, value=True)
    toto = Perso()
    toto.nameGenerator()
    toto.generate(text_A, headVal, bodyVal, leftArmVal, rightArmVal, leftLegVal, rightLegVal)
def reset(*args):
    #reset values:
    cmds.floatSliderGrp(headSlider, q=True, value=True, e = True)
    cmds.floatSliderGrp(headSlider, q=True, value=True, e = True)
    cmds.floatSliderGrp(bodySlider, q=True, value=True, e = True)
    cmds.floatSliderGrp(leftArmSlider, q=True, value=True, e  = True)
    cmds.floatSliderGrp(rightArmSlider, q=True, value=True, e = True)
    cmds.floatSliderGrp(leftLegSlider, q=True, value=True, e = True)
    cmds.floatSliderGrp(rightLegSlider, q=True, value=True, e = True)
cmds.showWindow()
